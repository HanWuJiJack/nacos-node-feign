...
var feign = /** @class */ (function () {
    function feign(_a) {
        var serverList = _a.serverList, namespace = _a.namespace, groupName = _a.groupName, serviceName = _a.serviceName, username = _a.username, password = _a.password;
        var _this = this;
    ...
    feign.prototype.getToken = function () {
    ...
    feign.prototype.threadsinit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.username && this.password)) return [3 /*break*/, 2];
                    ...
                    case 2:
                        TPools.run({
                            ...
                            else if (_this.MicroServerList.length === 0) {
                                if (_this.threadsinitsum > 2) {
                                    throw new Error("微服务已经全部宕机！");
                                }
                                setTimeout(function () {
                                    _this.threadsinitsum += 1;
                                    _this.threadsinit();
                                }, 1000);
                            }
                        });
